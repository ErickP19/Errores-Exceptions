...
public class ValidacionesPersona extends javax.swing.JFrame {
    ...
    ValidacionesPersona(Persona persona) {
    ...
    private void btnvalidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnvalidarActionPerformed
        ...
        try{
            ...
            Logger.getLogger(ValidacionesPersona.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ValidacionesPersona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ValidacionesPersona().setVisible(true);
            }
        });
    }
